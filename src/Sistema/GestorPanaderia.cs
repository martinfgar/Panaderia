...
public class GestorPanaderia
{
    ...
    public Dictionary<Producto, int> aProducirEnFecha(DateTime fecha)
    {
        ...
        if ((fecha - DateTime.Today).TotalDays > 1)
        {
    ...
    public float gastoEnLuzRangoFechas(DateTime inicio,DateTime final){
        float gasto=0;
    ...
    public float gastoEnHarinaEstimadoRangoFechas(DateTime inicio, DateTime final)
    {
        float gasto = 0;
    ...
    public float dineroPedidosRangoFechas(DateTime inicio, DateTime final)
    {
        float total = 0;
        while (inicio.CompareTo(final) <= 0)
        {
            ...
            if ((inicio - DateTime.Today).TotalDays > 1)
            {
